...
namespace Cat.Utility
{
    ...
    public class SafeHtmlParser
    {
        ...
        private string A(char a0)
        {
            if (_fg >= _ff)
            {
                return "";
            }
            int num1 = _fd.IndexOf(a0, _fg);
            if (num1 == -1)
            {
                return E();
            }
            int num2 = _fd.IndexOf('<', _fg, (num1 - _fg));
            if (num2 != -1)
            {
                num1 = num2;
            }
            string text1 = _fd.Substring(_fg, num1 - _fg);
            _fg = num1 + 1;
            return text1;
        }

        private string A(out string a0)
        {
            int num1 = _fg;
            a0 = d();
            string text1 = B();
        ...
        private static string A(string a0)
        {
            string text1;
            object obj1;
            ...
            if (Ca.R == null)
            {
                var hashtable1 = new Hashtable(0x404, 0.5f);
                hashtable1.Add("&quot;", 0);
                hashtable1.Add("&amp;", 1);
                hashtable1.Add("&lt;", 2);
                hashtable1.Add("&gt;", 3);
            ...
            if ((obj1 = a0.ToLower()) != null && ((obj1 = Ca.R[obj1]) != null))
            {
                switch (((int)obj1))
                {
                    case 0:
            ...
            try
            {
                var ch1 = (char)((ushort)short.Parse(a0.Substring(2, a0.Length - 3)));
                text1 = ch1.ToString(CultureInfo.InvariantCulture);
            }
            catch
            {
                text1 = a0;
        ...
        private string A(params char[] a0)
        {
            if (a0 == null) throw new ArgumentNullException("a0");
            if (_fg >= _ff)
            {
                return "";
            }
            int num1 = _fd.IndexOfAny(a0, _fg);
            if (num1 == -1)
            {
                return E();
            }
        ...
        private void A(XmlElement A_0)
        {
            ...
            {
                _fg += text1.Length;
                A_0.AppendChild(_fc.CreateProcessingInstruction(text1, A('>')));
            }
            else
            {
                A_0.AppendChild(_fc.CreateTextNode("<?"));
            }
        }
        ...
        private string B()
        {
            ...
            while (num2 < num1)
            {
                ch1 = _fd[num2];
                if ((((ch1 < 'a') || (ch1 > 'z')) && ((ch1 < 'A') || (ch1 > 'Z'))) &&
                    (((ch1 < '0') || (ch1 > '9')) && (((ch1 != '_') && (ch1 != '-')) && ((ch1 != '.') && (ch1 != ':')))))
                {
                    break;
                }
                num2++;
            }
            return _fd.Substring(_fg, num2 - _fg);
        }
        ...
        private static string B(string A_0)
        {
            ...
            {
                int num4 = A_0.IndexOfAny(Fh, num3 + 1);
                if (num4 == -1)
                {
                    break;
                }
                if (A_0[num4] == '&')
                {
                    builder1.Append(A_0, num2, (num4 - num2));
                    num3 = num4;
                    continue;
                }
                if (num2 != num3)
                {
                    builder1.Append(A_0, num2, (num3 - num2));
                }
                builder1.Append(A(A_0.Substring(num3, (num4 + 1) - num3)));
                num2 = num4 + 1;
                if (num2 >= num1)
                {
                    break;
            ...
            if (num2 < num1)
            {
                builder1.Append(A_0, num2, (num1 - num2));
            }
            return builder1.ToString();
        }
        ...
        {
            if (string.Compare(_fd, _fg, "[CDATA[", 0, 7, true) == 0)
            {
                _fg += 7;
                A_0.AppendChild(_fc.CreateCDataSection(c("]]>")));
            }
            else if (string.Compare(_fd, _fg, "--", 0, "--".Length, true) == 0)
            {
                _fg += 2;
                string text1 = c("-->");
                if (text1.IndexOf("--") != -1)
                ...
                A_0.AppendChild(_fc.CreateComment(text1));
            }
            else
            {
                string text2 = B();
                if (text2 != null)
                {
                    ...
                    try
                    {
                        A_0.AppendChild(_fc.CreateDocumentType(text2, null, null, A('>')));
                    }
                    catch
                    {
                    }
        ...
        private void c(XmlElement A_0)
        {
            while (_fg < _ff)
            {
                ...
                if (_fd[_fg] == '=')
                {
                    ...
                    {
                        _fg++;
                        var chArray1 = new char[2] { '>', ch1 };
                        text2 = A(chArray1);
                        if ((_fg < _ff) && (_fd[_fg] == ch1))
                        {
                            _fg++;
                        }
                    }
        ...
        {
            if (((_fg + 1) <= _ff) && ((_fd[_fg] == '<') && (_fd[_fg + 1] == '/')))
            {
                int num1 = _fg;
                _fg += 2;
                string text1 = B();
            ...
            if (_fg < num1)
            {
                ...
                if (text1 != null)
                {
                    ...
                    if (_fg < num1)
                    {
                        ...
                        {
                            string text3;
                            int num2 = _fe.IndexOf("</script", _fg);
                            if (num2 == -1)
                            {
                                text3 = F();
                            }
                            ...
                            {
                                text3 = _fd.Substring(_fg, num2 - _fg);
                                _fg = num2;
                            }
                            text3 = text3.Replace("/*<![CDATA[*/", "")
                                         ...
                                         .Trim()
                                         .Replace("]]>", "]]&gt;");
                            element1.AppendChild(_fc.CreateTextNode("/*"));
                            element1.AppendChild(_fc.CreateCDataSection("*/\r\n" + text3 + "\r\n/*"));
                            element1.AppendChild(_fc.CreateTextNode("*/"));
                        }
                        else
                        {
                            ...
                            if (
                                (",IFRAME,A,P,DIV,OBJECT,ADDRESS,BIG,BLOCKQUOTE,B,CAPTION,CENTER,CITE,CODE,\r\n\t\t\t\t\t\t\t\t\t,DD,DFN,DIR,DL,DT,EM,FONT,FORM,H1,H2,H3,H4,H5,H6,HEAD,HTML,I,LI,MAP,MENU,OL,OPTION,\r\n\t\t\t\t\t\t\t\t\t,PRE,SELECT,SMALL,STRIKE,STRONG,SUB,SUP,TABLE,TD,TEXTAREA,TH,TITLE,TR,TT,U,"
                                     .IndexOf("," + text2 + ",") != -1) && (element1.ChildNodes.Count == 0))
                            {
                                element1.AppendChild(_fc.CreateTextNode(""));
                            }
                        }
        ...
        private string E()
        {
            ...
            string text2 = _fd.Substring(_fg);
            _fg = _ff;
            return text2;
        }

        private XmlElement E(string a0)
        {
            XmlElement element1;
            a0 = a0.ToLower();
            try
            {
                if (a0.IndexOf(":", StringComparison.Ordinal) == -1)
                {
                    return _fc.CreateElement(a0);
                }
                var chArray1 = new char[1] { ':' };
                string[] textArray1 = a0.Split(chArray1, 2);
                string text1 = textArray1[0];
                string text2 = textArray1[1];
                ...
                if (text2 == "")
                {
                    _fc.CreateElement(text1);
                }
                if (text1 == "")
                {
                    return _fc.CreateElement(text2);
                }
                element1 = _fc.CreateElement(text1, text2, "http://unknownprefix/" + text1);
            }
            catch
            {
                element1 = _fc.CreateElement("error");
            }
            return element1;
        }

        private void E(XmlElement a0)
        {
            int num1 = _ff;
            while (_fg < num1)
            {
                ...
                _fg += text2.Length;
                a0.AppendChild(_fc.CreateTextNode(text1 + B(text2)));
            }
        }
        ...
        private string F()
        {
            if (_fg < _ff)
            {
                string text1 = _fd.Substring(_fg);
                _fg = _ff;
                return text1;
            }
            return "";
        ...
        private string G()
        {
            ...
            return _fd.Substring(num1, _fg - num1);
        }
        ...
        public static void ParseHtml(XmlElement element, string xmlstring)
        {
            ...
            var parser1 = new SafeHtmlParser();
            parser1._fc = element.OwnerDocument;
            parser1._fd = xmlstring;
            parser1._fe = xmlstring.ToLower();
            parser1._ff = xmlstring.Length;
            parser1._fg = 0;
            while (true)
            {
                parser1.E(element);
                if (parser1._fg >= parser1._ff)
                {
                    return;
                }
                parser1.H();
