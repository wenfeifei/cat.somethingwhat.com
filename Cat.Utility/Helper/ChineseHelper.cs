...
namespace Cat.Utility
{
    ...
    public static class ChineseHelper
    {
        ...
        public static List<char> GetChineseChars(this string content)
        {
            ...
            foreach (var chars in from Match mc in reg.Matches(content) select mc.Groups[0].Value.ToCharArray())
            {
        ...
        /// <param name="content">原始串</param>
        /// <returns>原始串中的中文集合</returns>
        public static List<string> GetChineseStrings(this string content)
        {
            const string regStr = "[\u4e00-\u9fa5]+";
            var reg = new Regex(regStr, RegexOptions.IgnoreCase | RegexOptions.Compiled);
            return (from Match mc in reg.Matches(content) select mc.Groups[0].Value).ToList();
        }
        ...
        private static readonly int[] PyValue = new[]
                                                    {
                                                        ...
                                                        -19756, -19751, -19746, -19741, -19739, -19728, -19725, -19715,
                                                        ...
                                                        -18731, -18722, -18710, -18697, -18696, -18526, -18518, -18501,
                                                        ...
                                                        -17468, -17454, -17433, -17427, -17417, -17202, -17185, -16983,
                                                        ...
                                                        -15933, -15920, -15915, -15903, -15889, -15878, -15707, -15701,
                                                        ...
                                                        -14941, -14937, -14933, -14930, -14929, -14928, -14926, -14922,
                                                        ...
                                                        -14109, -14099, -14097, -14094, -14092, -14090, -14087, -14083,
                                                        ...
                                                        -13068, -13063, -13060, -12888, -12875, -12871, -12860, -12858,
                                                        ...
                                                        -11055, -11052, -11045, -11041, -11038, -11024, -11020, -11019,
        ...
        private static readonly string[] PyName = new[]
                                                      {
                                                          ...
                                                          "Dou", "Du", "Duan", "Dui",
                                                          "Dun", "Duo", "E", "En", "Er", "Fa", "Fan", "Fang", "Fei",
                                                          "Fen", "Feng", "Fo",
                                                          "Fou", "Fu", "Ga", "Gai", "Gan", "Gang", "Gao", "Ge", "Gei",
                                                          "Gen", "Geng", "Gong",
                                                          "Gou", "Gu", "Gua", "Guai", "Guan", "Guang", "Gui", "Gun",
                                                          "Guo", "Ha", "Hai", "Han",
                                                          "Hang", "Hao", "He", "Hei", "Hen", "Heng", "Hong", "Hou", "Hu"
                                                          , "Hua", "Huai", "Huan",
                                                          ...
                                                          "Nai", "Nan", "Nang",
                                                          "Nao", "Ne", "Nei", "Nen", "Neng", "Ni", "Nian", "Niang",
                                                          "Niao", "Nie", "Nin", "Ning",
                                                          "Niu", "Nong", "Nu", "Nv", "Nuan", "Nue", "Nuo", "O", "Ou",
                                                          "Pa", "Pai", "Pan",
                                                          ...
                                                          "Zha", "Zhai", "Zhan",
                                                          "Zhang", "Zhao", "Zhe", "Zhen", "Zheng", "Zhi", "Zhong",
        ...
        public static string ToPinyinString(this string hanZi)
        {
            // 匹配中文字符
            ...
            {
                // 中文字符
                if (regex.IsMatch(charArray[j].ToString(CultureInfo.InvariantCulture)))
                {
                    byte[] array = Encoding.Default.GetBytes(charArray[j].ToString(CultureInfo.InvariantCulture));
                    int i1 = (array[0]);
                    int i2 = (array[1]);
                    int chrAsc = i1 * 256 + i2 - 65536;
                    if (chrAsc > 0 && chrAsc < 160)
                    {
                        pyString += charArray[j];
                    }
                    else
                    {
                        // 修正部分文字
                ...
                {
                    pyString += charArray[j].ToString(CultureInfo.InvariantCulture);
                }
            }
            return pyString;
        }
        ...
        /// <returns>转换后的拼音(全拼)字符串</returns>
        public static string ToPinyinStringWithBlank(this string hzString)
        {
            // 匹配中文字符
            var regex = new Regex("^[\u4e00-\u9fa5]$");
            string pyString = "";
            char[] charArray = hzString.ToCharArray();
            ...
            for (int j = 0; j < charArray.Length; j++)
            {
                ...
                {
                    pyString = pyString + " " + charArray[j].ToString(CultureInfo.InvariantCulture);
                }
            }
        ...
        /// <returns>转换后的拼音(全拼)字符串</returns>
        public static string ToPinyinStringWithSplitChar(this string hzString, string splitChar)
        {
            // 匹配中文字符
            var regex = new Regex("^[\u4e00-\u9fa5]$");
            string pyString = "";
            ...
            for (int j = 0; j < charArray.Length; j++)
            {
                ...
                if (regex.IsMatch(charArray[j].ToString(CultureInfo.InvariantCulture)))
                {
                    ...
                    if (chrAsc > 0 && chrAsc < 160)
                    {
                        pyString = pyString + splitChar + charArray[j];
                    }
                    else
                    {
                        // 修正部分文字
                ...
                {
                    pyString = pyString + splitChar + charArray[j].ToString(CultureInfo.InvariantCulture);
                }
            }
        ...
        public static string GetSpellStringLower(string chineseString)
        {
            string tempStr = "";
            foreach (char c in chineseString)
            {
                ...
                {
                    //字母和符号原样保留
                    tempStr += c.ToString(CultureInfo.InvariantCulture);
                }
                else
                {
                    //累加拼音声母
                    tempStr += ToLowerSpellChar(c.ToString(CultureInfo.InvariantCulture));
                }
            }
            return tempStr;
        }
        ...
        public static string GetSpellStringLowerSplitWithBlank(string str)
        {
            ...
            foreach (char c in str)
            {
                ...
                {
                    //字母和符号原样保留
                    tempStr = tempStr + " " + c.ToString(CultureInfo.InvariantCulture);
                }
                else
                {
                    //累加拼音声母
                    tempStr = tempStr + " " + ToLowerSpellChar(c.ToString(CultureInfo.InvariantCulture));
                }
            }
            return tempStr.Trim();
        }
        ...
        /// <param name="str">要转换的汉字字符串</param>
        /// <returns>拼音缩写</returns>
        public static string ToFirstrCharUpperSpellString(this string str)
        {
            string s = "";
            foreach (char c in str)
            {
                ...
                {
                    //累加拼音声母
                    s += ChanageChineseCharToSpellChar(c.ToString(CultureInfo.InvariantCulture));
                }
            }
            return s;
        }
        ...
        /// <param name="str">要转换的汉字字符串</param>
        /// <returns>拼音缩写</returns>
        public static string ToSupperSpellStringWithBlank(this string str)
        {
            string tempStr = "";
            foreach (char c in str)
            {
                ...
                {
                    //累加拼音声母
                    tempStr = tempStr + " " + ChanageChineseCharToSpellChar(c.ToString(CultureInfo.InvariantCulture));
                }
            }
            return tempStr.Trim();
        }
        ...
        private static string ChanageChineseCharToSpellChar(this string c)
        {
        ...
        ///     取单个字符的拼音声母
        /// </summary>
        /// <param name="chineseString">要转换的单个汉字</param>
        /// <returns>拼音声母</returns>
        private static string ToLowerSpellChar(this string chineseString)
        {
            byte[] array = Encoding.Default.GetBytes(chineseString);
            int i = (short)(array[0] - '\0') * 256 + ((short)(array[1] - '\0'));

            if (i < 0xB0A1) return chineseString;
            if (i < 0xB0C5) return "a";
            if (i < 0xB2C1) return "b";
            if (i < 0xB4EE) return "c";
            if (i < 0xB6EA) return "d";
