...
{
    public class MongoDbService : AppBaseService<Sys_Log>, ILogService
    {
        public MongoDbService() : base(Cat.Foundation.ConfigManager.ConnectionStrings.MongoDB.DBName)
        {
