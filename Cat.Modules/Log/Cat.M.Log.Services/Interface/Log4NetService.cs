...
namespace Cat.M.Log.Services
{
    public class Log4NetService : ILogService
    {
        ...
        {
            this.log = LogManager.GetLogger("RollingLogFileAppender", typeof(Log4NetService));
        }
